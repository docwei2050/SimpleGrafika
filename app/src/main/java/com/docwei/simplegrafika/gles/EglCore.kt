 ...
 */
package com.docwei.simplegrafika.gles
 ...
 */
class EglCore  constructor(sharedContext: EGLContext? = null, flags: Int = 0) {
...
// every eglInitialize() we need an eglTerminate().
    ...
    fun makeCurrent(eglSurface: EGLSurface?) {
        if (mEGLDisplay === EGL14.EGL_NO_DISPLAY) { // called makeCurrent() before create?
    ...
    init {
        ...
        if (flags and FLAG_TRY_GLES3 != 0) { //Log.d("grafika", "Trying GLES 3");
            ...
            if (config != null) {
                ...
                if (EGL14.eglGetError() == EGL14.EGL_SUCCESS) { //Log.d("grafika", "Got GLES 3 config");
                    mEGLConfig = config
                    mEGLContext = context
                    glVersion = 3
                }
...
//Log.d("grafika", "Trying GLES 2");
        ...
        Log.d("grafika", "EGLContext created, client version " + values[0])
    }
}