...
// Android 4.4 this may not be happening.
        ...
        } else { // Compute the desired time delta between the previous frame and this frame.
            var frameDelta: Long
            if (mLoopReset) { // We don't get an indication of how long the last frame should appear
...
// for now we just use 30fps.
            ...
            } else if (frameDelta > 10 * ONE_MILLION) { // Inter-frame times could be arbitrarily long.  For this player, we want
...
// accidentally output timestamps in nsec rather than usec).
            ...
            while (nowUsec < desiredUsec - 100 /*&& mState == RUNNING*/) { // Sleep until it's time to wake up.  To be responsive to "stop" commands
